...
var factoryPolitician = function(nameType, partyColour){
...
var winner = "???"
  ...
  } else if ( Candidate2.addArrayforVotes() > Candidate1.addArrayforVotes() ){
...
var RowenaColour = factoryPolitician("Rowena Rocks", [132, 17, 11]);
var LilyColour = factoryPolitician("Lily deLivers", [245, 141, 136]);

console.log("Rowena's colour is RGB " + RowenaColour.partyColour);
console.log("Lily's colour is RGB " + LilyColour.partyColour);
// ;




/* THIS IS THE MAP.JS SKILLCRUSH FILE - Map Technology Copyright (C) 2011 DougX.net, used with permission */
...
var getStateResults = function(state) {
  ...
  // F Candidate 1's has more votes for that state than Candidate 2 THEN
  //     Candidate 1 is the winner of that state!
  // ELSE IF Candidate 2 has more votes than Candidate 1 THEN
  //     Candidate 2 is the winner of that state
};
...
//
// stateResults.children[0].children[0].children[0].innerText = state;
// stateResults.children[0].children[0].children[1].innerText = stateAbbrev;
// stateResults.children[1].children[0].children[0].innerText = "Rowena Rocks";
// stateResults.children[1].children[0].children[1].innerText = Candidate1.totalVotes;
// stateResults.children[1].children[1].children[0].innerText = "Lily deLivers";
// stateResults.children[1].children[1].children[1].innerText = Candidate2.totalVotes;
// stateResults.children[1].children[2].children[0].innerText = "Winner: ";
// stateResults.children[1].children[2].children[1].innerText = winner;
